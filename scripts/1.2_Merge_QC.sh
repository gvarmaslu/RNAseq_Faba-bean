...
#./1.2_Merge_QC.sh > 1.2_Merge_QC.sh.log 2>&1
...
mkdir -p ${work_dir}1.1_sort-trim_FastQC/
out_dir1=${work_dir}1.1_sort-trim_FastQC/

mkdir -p ${work_dir}1.2_sort-trim_MultiQC/
out_dir2=${work_dir}1.2_sort-trim_MultiQC/


cd ${work_dir}


for f in `ls /home/gala0002/proj/proj_dir/1.0_sort-trim/*/*_1.fq.gz`; do
